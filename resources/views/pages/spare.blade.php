    ...
    <h4>No record found.</h4>
                ...
                <div id="shop-2" class="tab-pane">
                    <div class="shop-list-wrap mb-30">
                        <div class="row">
                           <!-- Spare Part Product 1 -->
<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 product-item" data-category="spare-parts">
    <div class="single-product-wrap mb-35">
        <div class="product-img product-img-zoom mb-15">
            <a href="#"><img src="assets/images/product/p2055-fuser.jpg" alt="HP P2055 Fuser Assy"></a>
        </div>
        <div class="product-content-wrap-2 text-center">
            <h3><a href="#">HP P2055 Fuser Assy</a></h3>
            <div class="product-price-2">
                <span>RM300.00</span>
            </div>
            <div class="pro-add-to-cart mt-10">
...
<!-- Spare Part Product 2 -->
<div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 product-item" data-category="spare-parts">
    <div class="single-product-wrap mb-35">
        <div class="product-img product-img-zoom mb-15">
            <a href="#"><img src="assets/images/product/p2055-roller.jpg" alt="Lower Pressure Roller P2055"></a>
        </div>
        <div class="product-content-wrap-2 text-center">
            <h3><a href="#">Lower Pressure Roller P2055 (Sponge)</a></h3>
            <div class="product-price-2">
                <span>RM80.00</span>
            </div>
            <div class="pro-add-to-cart mt-10">
...
<div id="no-record-message" style="display: none; width: 100%; text-align: center; padding: 40px;">
    <h4>No record found.</h4>
                    ...
                    <div class="col-lg-3">
                        <div class="sidebar-wrapper sidebar-wrapper-mrg-right">
                            <div class="sidebar-widget mb-10 pt-10">
                            ...
                            <div class="sidebar-widget shop-sidebar-border mb-10 pt-10">
                                <h4 class="sidebar-widget-title">Categories </h4>
                                <div class="shop-catigory">
                                    <ul>
                                        <li><a href="javascript:void(0);" class="category-filter" data-category="Spare Parts">Spare Parts</a></li>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // 默认显示 compatible 分类
            const defaultCategory = "Spare Parts";
